// Datos de productos para la API
const products = [
    {
        id: 1,
    ...
    },
    {
        ...
        description: "Mesa de noche elegante con cajón y acabado en madera natural.",
        price: 15000,
        image: "https://images.pexels.com/photos/1080721/pexels-photo-1080721.jpeg?auto=compress&cs=tinysrgb&w=400",
        category: "mesas",
        featured: false,
        specifications: {
            ...
            "Dimensiones": "50cm x 40cm x 60cm",
            "Cajón": "1 cajón con manija",
            "Acabado": "Cera natural",
            "Garantía": "3 años"
        }
    },
    {
        ...
        description: "Silla ergonómica para oficina con respaldo ajustable y ruedas.",
        price: 25000,
        image: "https://images.pexels.com/photos/586765/pexels-photo-586765.jpeg?auto=compress&cs=tinysrgb&w=400",
        category: "sillas",
        featured: false,
        specifications: {
            ...
            "Dimensiones": "60cm x 60cm x 120cm",
            "Altura": "Ajustable",
            "Acabado": "Cuero genuino",
            "Garantía": "5 años"
        }
    },
    {
        id: 11,
        name: "Sofá Patagonia",
        description: "Sofá de 3 plazas con tapizado en tela resistente y estructura de madera.",
        price: 95000,
        image: "https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg?auto=compress&cs=tinysrgb&w=400",
        category: "sofas",
        featured: true,
        specifications: {
            "Material": "Madera de roble y tela",
            "Dimensiones": "220cm x 90cm x 85cm",
            "Plazas": "3 plazas",
            "Acabado": "Tela resistente",
            "Garantía": "8 años"
        }
    }
];
